...
public class JsonConverterLocalTime extends JsonConverter<LocalTime> {

    @Override
    public TypeToken<LocalTime> getMyType() {
        return TypeToken.get(LocalTime.class);
    }
    ...
    public Object deserialize(JsonElement element, TypeToken<?> typeToConvert, JsonSerializerOptions options) {
        ...
        return LocalTime.parse(element.getAsJsonPrimitive().getAsString());
    }
}
